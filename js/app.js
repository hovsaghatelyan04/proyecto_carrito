...
function eliminarCurso(e) {
    ...
    if(e.target.classList.contains('borrar-curso')) {
        ...
        // Eliminar del arreglo por articulosCarrito data-id
        articulosCarrito = articulosCarrito.filter(curso => curso.id !== cursoID);
        carritoHTML(); // Iterar sobre el carrito ymuestra su HTML
...
function leerDatosCurso(curso) {
        ...
        // Revista si un elemento ya existe en el carrito
        ...
        if(existe) {
            ...
            const cursos = articulosCarrito.map((curso) => {
                if(curso.id === infoCurso.id) {
                    ...
                    return curso; // retorn los ojbetos que no son ducpliados
                }
             });
